...
## Reading the Dataset 
DiabetesData = pd.read_csv('data02.csv', encoding='unicode_escape')

# Instantiate the class Data
data = Data()

# Replace string to int
data.Replace(DiabetesData)
