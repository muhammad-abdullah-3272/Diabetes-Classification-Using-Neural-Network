...
# Create dense layer with 11 input features and 30 output values
dense1 = Layer_Dense(3, 30, weight_regularizer_l2=0)

# Create ReLU activation (to be used with upper dense layer)
activation1 = Activation_ReLU()

# Create dense layer with 30 input values from above layer and 30 output values
dense2 = Layer_Dense(30, 30, weight_regularizer_l2=0)

# Create ReLU activation (to be used with upper dense layer)
activation2 = Activation_ReLU()

# Create dense layer with 30 input values from above layer and 30 output values
dense3 = Layer_Dense(30, 30, weight_regularizer_l2=0)

# Create ReLU activation (to be used with upper dense layer)
activation3 = Activation_ReLU()

# Create dense layer with 30 input values from above layer and 1 output prediction value
dense4 = Layer_Dense(30, 1)
...
for epoch in range(1001):
    ...
    # Perform forward pass through 2nd dense layer, takes output of activation of 2nd layer
    ...
    # Perform forward pass through 3rd dense layer, takes output of activation of 3rd layer
    dense4.forward(activation3.output, activation3.val_output)

    # Perform forward pass through activation function, takes output of 4th dense layer
    activation4.forward(dense4.output, dense4.val_output)
    

    # Calculate the training and validation data loss
    train_data_loss = loss_function.calculate(activation4.output, Y_train)
    val_data_loss = loss_function.calculate(activation4.val_output, Y_val)
    ...
    loss_function.backward(activation4.output, Y_train)
