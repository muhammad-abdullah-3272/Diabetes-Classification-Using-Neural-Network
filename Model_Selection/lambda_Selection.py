...
# Initializing lambdas for optimal lambda selection
lamdas = [0, 0.0001, 0.0003, 0.0005, 0.001, 0.003, 0.005, 0.01, 0.05, 0.1, 0.5, 1]
...
for lamda in lamdas:
    ...
    dense1 = Layer_Dense(3, 7, weight_regularizer_l2=lamda)
    ...
    for epoch in range(41):
        ...
        train_data_loss = loss_function.calculate(activation2.output, Y_train)
        val_data_loss = loss_function.calculate(activation2.val_output, Y_val)
        
        # Calculate regularization penalty on both dense layers
        ...
        # Calculate accuracy from output of activaion2 and actual labels
